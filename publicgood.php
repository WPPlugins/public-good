...
?>
		...
		<option value='0' <?php if ( "0" == esc_attr ( $opt_val_size ) ) print "selected" ?>>Default</option>
		<option value='1' <?php if ( "1" == esc_attr ( $opt_val_size ) ) print "selected" ?>>Small Button</option>
		</select></p>
		...
		<p>The source is the part of your Public Good url which follows "publicgood.com/org/". For example, if your Public Good profile is at https://publicgood.com/org/my-organization, use "my-organization".</p>
                <p>If you have questions or need a hand getting set up, don't hesitate to drop a line to Public Good Support at <a href="https://publicgood.zendesk.com/hc/en-us/requests/new">https://publicgood.zendesk.com/hc/en-us/requests/new</a>.</p>
		</div>
